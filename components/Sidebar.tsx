...
export function Sidebar() {
  ...
  return (
    <aside className={`relative flex flex-col h-screen bg-[#0B0F19] border-r border-white/[0.05] transition-all duration-300 ${collapsed ? 'w-[76px]' : 'w-64'}`}>
      ...
      <div className="px-3 mt-3">
        <Link href="/rfqs/new">
          <button className="w-full flex items-center justify-center gap-2 bg-cyan-400 text-black px-3 py-2 rounded-xl hover:bg-cyan-300 transition">
      ...
      {/* NAV */}
      <div ref={containerRef} className="flex-1 overflow-y-auto px-2 py-4 relative">
      ...
      <div className="p-4 border-t border-white/[0.05]">
        ...
        {openUser && !collapsed && (
          <div className="mt-3 bg-[#111827] border border-white/10 rounded-xl p-2">
